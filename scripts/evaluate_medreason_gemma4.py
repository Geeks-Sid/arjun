#!/usr/bin/env python
"""Reload a Gemma 4 E4B adapter and evaluate it offline.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/runs/medreason/local_gemma4_e4b_pilot_eval"))
...
def load_adapter(args: argparse.Namespace) -> tuple[Any, Any, torch.device]:
    ...
    base = AutoModelForMultimodalLM.from_pretrained(args.model, **kwargs)
...
def main() -> int:
    ...
    summary = {
        "run_kind": "local_diagnostic_gemma4_e4b_adapter_evaluation",
